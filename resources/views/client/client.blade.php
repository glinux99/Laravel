...
@section('contenu')
    <div class="col-lg-11 mx-auto card adC2">
        ...
        <img src="{{url($data['photo'])}}" alt="user-default-profil" style="z-index:2;border: 1px double green;" id="img" class="align-self-center adC rounded-circle mt-3" width="200rem" height="200rem">
        </div>
