                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start">
                            ...
                            <ul class="list-unstyled ml-4">
                                <li class="mb-2">
                                    <a href="../B_users/modifier_compte.php">
                                        <i class="bi-pencil-square bi--xl "></i> <?php echo _("Modifier");?>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="../B_users/profil_user.php" >
                                        <i class="bi-person-check-fill bi--xl "></i> <?php echo _("Afficher profil");?>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li class="nav-item border-bottom w-100 pt-2 pb-2">
                        <a href="rapports.php" class="nav-link align-middle px-0 mhl  h-50" data-toggle="modal" data-target="#rapport">
                            <i class="bi-stack bi--xl "></i>  <span class="ms-1 d-none d-sm-inline"><?php echo _("Rapports");?></span>
                        </a>
                    </li>
                    <li class="nav-item border-bottom w-100 pt-2 pb-2">
